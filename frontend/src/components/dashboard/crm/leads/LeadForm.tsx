      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          <PageHeader 
            ...
            description={isEdit ? "Update lead details and stage." : "Capture new inquiry details and requirements."}
          />
        </div>
      </div>
          ...
          <form onSubmit={handleSave} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input 
                  ...
                  defaultValue={isEdit ? "Rahul Verma" : ""}
                  required
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <input 
                  ...
                  defaultValue={isEdit ? "9829012345" : ""}
                  required
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <select 
                  className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                  defaultValue={isEdit ? "Instagram" : "Phone Call"}
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <label className="text-sm font-medium">Proposed Event Date <span className="text-red-500">*</span></label>
                <input 
                  type="date" 
                  className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                  required
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <select 
                  className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                  defaultValue={isEdit ? "Site Visit" : "New"}
                >
              ...
              <div className="space-y-2">
                ...
                <select 
                  ...
                  defaultValue="1"
                >
                  <option value="1">Ravi (Manager)</option>
                  <option value="2">Amit (Supervisor)</option>
            ...
            <div className="space-y-2">
              ...
              <textarea 
                className="flex min-h-[100px] w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                placeholder="Enter any initial requirements discussed..."
              ></textarea>
            </div>

...
export default function RolesView() {
  ...
  if (error) return <div className="text-error p-4">Failed to load roles.</div>;
    ...
    <div className="flex flex-col md:flex-row gap-6 h-full p-6">
      ...
      <div className="w-full md:w-1/3 flex flex-col gap-4">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-bold font-display">Roles & Permissions</h2>
      ...
      <div className="w-full md:w-2/3 bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm flex flex-col">
        {(selectedRole || isCreating) ? (
          <div className="flex flex-col h-full">
            ...
            <div className="p-6 overflow-y-auto flex-1 space-y-6">
              ...
              <div className="space-y-4">
                <h4 className="font-semibold text-zinc-800 dark:text-zinc-200">Permissions</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                  {PERMISSION_MODULES.map(module => {
                    ...
                    <div key={module.module} className="space-y-3 p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/50">
                      <div className="flex items-center justify-between">
                        <h5 className="text-sm font-bold text-zinc-900 dark:text-white capitalize">{module.label}</h5>
                        <button
                          type="button"
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-zinc-400 p-6 text-center">
            ...
            <h3 className="text-lg font-medium text-zinc-900 dark:text-white mb-2">No Role Selected</h3>
            <p className="max-w-sm">Select a role from the sidebar to view or edit its permissions, or create a new one.</p>
          </div>
        )}
      </div>
